...
export class SeedService {
  ...
  async seed() {
    ...
    if (!owner) {
      throw new Error('Propriétaire with ID = 2 was not found in the database!');
    }
    ...
    const equipmentData = [
      {
        ...
        description: 'Mini-pelle compacte et performante, idéale pour les travaux de tranchées, fondations et aménagement paysager dans les espaces restreints. Force de cavage exceptionnelle.',
        prix_location: 850,
      ...
      },
      {
        ...
        description: 'Pelle sur chenilles puissante offrant une productivité exceptionnelle pour les grands chantiers de terrassement et d\'excavation de masse. Confort cabine amélioré.',
        prix_location: 3200,
        categorie: 'Terrassement',
        localisation: 'Tanger',
      ...
      },
      {
        ...
        description: 'Chargeuse polyvalente conçue pour le chargement rapide de camions et la manutention de matériaux lourds dans les carrières et grands chantiers.',
        prix_location: 3800,
        categorie: 'Terrassement',
        localisation: 'Marrakech',
        images: 'https://images.unsplash.com/photo-1605787020600-b9ebd5df1d07?auto=format&fit=crop&w=600&q=80',
      ...
      },
      {
        ...
        description: 'Bulldozer sur chenilles hautement robuste doté d\'une lame de nivellement haute capacité, parfait pour le défrichage et la préparation de terrains difficiles.',
        prix_location: 4500,
        categorie: 'Terrassement',
        localisation: 'Rabat',
      ...
      },
      {
        ...
        description: 'Bétonnière tractable à moteur électrique, idéale pour le malaxage efficace de mortier, plâtre et béton sur tous types de chantiers de construction.',
        prix_location: 300,
      ...
      },
      {
        ...
        description: 'Camion pompe à béton avec flèche articulée de 38 mètres pour le coulage rapide et précis des dalles dans les zones d\'accès complexe ou en hauteur.',
        prix_location: 4200,
        categorie: 'Gros œuvre',
        localisation: 'Casablanca',
      ...
      },
      {
        ...
        description: 'Kit complet de coffrage manuportable en aluminium pour dalle béton. Facile d\'utilisation et réduit considérablement le temps de mise en œuvre.',
        prix_location: 750,
        categorie: 'Gros œuvre',
        localisation: 'Rabat',
        images: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=600&q=80',
      ...
      },
      {
        ...
        description: 'Vibrateur à béton thermique professionnel indispensable pour chasser les bulles d\'air et assurer la compacité maximale du béton coulé dans les coffrages.',
        prix_location: 350,
        categorie: 'Gros œuvre',
        localisation: 'Tanger',
        images: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&w=600&q=80',
      ...
      },
      {
        ...
        description: 'Groupe électrogène insonorisé robuste fournissant une source d\'énergie fiable pour alimenter l\'ensemble de vos outils électriques et bases de vie de chantier.',
        prix_location: 1100,
        categorie: 'Énergie',
        localisation: 'Marrakech',
      ...
      },
      {
        ...
        description: 'Groupe électrogène industriel haute performance, insonorisé, conçu pour les applications de secours ou de production continue de forte puissance.',
        prix_location: 2400,
        categorie: 'Énergie',
        localisation: 'Casablanca',
        images: 'https://images.unsplash.com/photo-1622675363311-3e1904dd188f?auto=format&fit=crop&w=600&q=80',
      ...
      },
      {
        ...
        description: 'Tour d\'éclairage mobile autonome équipée de puissants projecteurs LED pour éclairer de grandes zones de chantier la nuit en toute sécurité et autonomie.',
        prix_location: 550,
        categorie: 'Énergie',
        localisation: 'Agadir',
      ...
      },
      {
        ...
        description: 'Grue à tour moderne avec flèche de 52 mètres, offrant une excellente capacité de levage et une grande facilité de montage pour les bâtiments résidentiels.',
        prix_location: 4000,
        categorie: 'Levage',
        localisation: 'Casablanca',
        images: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&w=600&q=80',
      ...
      },
      {
        ...
        description: 'Chariot élévateur télescopique de 18 mètres de portée. Idéal pour la manutention, le chargement et le déchargement de charges lourdes et volumineuses.',
        prix_location: 1700,
        categorie: 'Levage',
        localisation: 'Marrakech',
      ...
      },
      {
        ...
        description: 'Nacelle automotrice articulée offrant une grande flexibilité de positionnement grâce à son bras articulé télescopique. Hauteur de travail utile : 16m.',
        prix_location: 1050,
        categorie: 'Levage',
        localisation: 'Rabat',
      ...
      },
      {
        ...
        description: 'Grue télescopique tout terrain rapide à déployer avec une capacité nominale de 50 tonnes pour des levages lourds sur chantiers industriels et BTP.',
        prix_location: 4800,
        categorie: 'Levage',
        localisation: 'Tanger',
        images: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&w=600&q=80',
      ...
      },
      {
        ...
        description: 'Compacteur de sol vibrant monocylindre de 11 tonnes, très performant pour le traitement et le compactage de la terre, des graviers et de l\'asphalte.',
        prix_location: 1550,
      ...
      },
      {
        ...
        description: 'Plaque de compactage réversible à entraînement diesel, idéale pour le compactage de pavés autobloquants, tranchées et remblais étroits.',
        prix_location: 400,
        categorie: 'Compactage',
        localisation: 'Marrakech',
        images: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=600&q=80',
      ...
      },
      {
        ...
        description: 'Rouleau compresseur tandem vibrant léger, idéal pour les travaux de finition, l\'entretien routier et le compactage d\'enrobés de petite surface.',
        prix_location: 950,
        categorie: 'Compactage',
        localisation: 'Agadir',
        images: 'https://images.unsplash.com/photo-1579294800821-694d95e86143?auto=format&fit=crop&w=600&q=80',
    ...
    const materiels = equipmentData.map(item => this.materielRepository.create({
      ...item,
      proprietaire: owner,
    }));
    ...
    const demandsData = [
      {
        ...
        endDate: '2026-06-20',
        budget: '900 DH/jour',
        description: 'Recherche mini-pelle de 3.5 tonnes avec chauffeur pour des travaux de tranchées en milieu urbain.',
        status: 'pending',
      },
      {
        ...
        endDate: '2026-07-05',
        budget: '600 DH/jour',
        description: 'Besoin d\'un chariot élévateur industriel pour déchargement de palettes et stockage en entrepôt.',
        status: 'pending',
      },
      {
        ...
        endDate: '2026-06-17',
        budget: '1200 DH/jour',
        description: 'Recherche groupe électrogène insonorisé de 100 kVA pour alimentation temporaire d\'un chantier de nuit.',
        status: 'accepted',
      },
      {
        ...
        endDate: '2026-06-26',
        budget: '4500 DH/jour',
        description: 'Opération de levage lourd de structures métalliques préfabriquées. Durée d\'une journée.',
        status: 'pending',
      },
      {
        ...
        endDate: '2026-06-23',
        budget: '1500 DH/jour',
        description: 'Recherche compacteur Hamm ou similaire pour le terrassement et la préparation de voirie.',
        status: 'pending',
      },
    ];
