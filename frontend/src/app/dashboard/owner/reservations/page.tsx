      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
        <div className="xl:col-span-8 flex flex-col gap-8">
          <div className="flex gap-4 border-b border-surface-container pb-4">
            {["Pending", "Confirmed", "Completed"].map((tab, i) => (
              <button
                key={tab}
            ...
            {reservations.map((res) => {
              ...
              return (
                <TableRow key={res.id}>
                  ...
                  <TableCell>
                    <div className="font-bold">${eq ? eq.pricePerDay * 5 : 0}</div>
                  </TableCell>
                  <TableCell>
                    <div className="flex gap-2">
                      <Button variant="secondary" size="sm" className="bg-green-50 text-green-700 hover:bg-green-100 p-2">
                        <CheckCircle size={18} />
                      </Button>
                      <Button variant="secondary" size="sm" className="bg-red-50 text-red-700 hover:bg-red-100 p-2">
                        <XCircle size={18} />
                      </Button>
