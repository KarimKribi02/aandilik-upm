      ...
      <div className="w-full max-w-[480px] z-10">
        ...
        <div className="glass p-10 rounded-[40px] border border-white/20 cosmic-shadow bg-white/40">
          <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
            {error && (
              <div className="p-4 bg-orange-50 border border-orange-200 text-orange-600 rounded-xl text-xs font-bold">
                {error}
              </div>
            )}
            <Input 
            ...
            <Button size="lg" className="w-full font-black mt-2" loading={loading}>
